...
alias ipy='ipython qtconsole --profile=default --pylab=inline' #Start up the qt4-based ipython
alias less='less -FSRXc'                    # Preferred 'less' implementation
function pvi()                              # Use wildcard to open file with vim
{
    # ...find the name of file with wildcard
    name=$(ls -la | grep '^-' | egrep $1 | sed 's/.* //g')
    echo "Opening File..."
    echo $name
    if [ -z "$name" ];then
